        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                <a href="https://github.com/adityakumar732" className='text-foreground/60 hover:text-foreground/80'>
                <img src={GitHub} alt="" className='h-16 w-16'/></a>
                <a href="https://www.instagram.com/suri_aditya122?igsh=MTRnNjc0Yzh4M3VseA==" className='text-foreground/60 hover:text-foreground/80'>
                <img src={instagram} alt="" className='h-16 w-16'/></a>
                <a href="https://www.linkedin.com/in/aditya-kumar-3b3449326" className='text-foreground/60 hover:text-foreground/80'>
                <img src={linkedin} alt="" className='h-16 w-16'/></a>
              </div>

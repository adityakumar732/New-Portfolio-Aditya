      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
          <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-1'>
            ...
            <button className='bg-black text-white px-3 py-2 w-max rounded-md hover:bg-red-500 '><a href="https://drive.google.com/uc?export=download&id=1H5YaYCE8h3zNvzYaPrUebDcfKhlYBrVD" download target='_blank'>Download CV</a></button>
          </div>
